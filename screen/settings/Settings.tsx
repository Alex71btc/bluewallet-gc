...
const Settings = () => {
  ...
  return (
    <SafeAreaScrollView>
      <ListItem title={loc.settings.general} onPress={() => navigate('General')} testID="General" chevron />
      ...
      <ListItem title={loc.settings.tools} onPress={() => navigate('SettingsTools')} testID="Tools" chevron />

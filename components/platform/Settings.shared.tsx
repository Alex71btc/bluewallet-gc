...
export const getSettingsIconColor = (name: SettingsIconName) => {
...
export const createSettingsListItem = (
  getIconProps: (name: SettingsIconName) => PlatformListItemProps['leftIcon'],
): React.FC<SettingsListItemProps> => {
  const SettingsListItem: React.FC<SettingsListItemProps> = props => {
